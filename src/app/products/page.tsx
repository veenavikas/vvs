            ...
            <div className="arch-layout-grid">
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
                  <div style={{ background: "rgba(0,0,0,0.3)", padding: "12px", borderRadius: "6px", border: "1px solid rgba(255,255,255,0.03)" }}>
                  ...
                  <div style={{ background: "rgba(0,0,0,0.3)", padding: "12px", borderRadius: "6px", border: "1px solid rgba(255,255,255,0.03)" }}>
                    <div style={{ fontFamily: "var(--font-mono)", color: "var(--accent-teal)", fontSize: "20px", fontWeight: "bold" }}>10k+</div>
          ...
          <div className="product-arch-card">
            ...
            <div className="arch-layout-grid">
              <div>
                ...
                <pre style={{ background: "rgba(0,0,0,0.4)", padding: "16px", borderRadius: "6px", fontSize: "11px", color: "var(--accent-teal)", border: "1px solid rgba(255,255,255,0.03)", overflowX: "auto", fontFamily: "var(--font-mono)" }}>
            ...
            <div className="arch-layout-grid">
              <div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", color: "var(--text-cream)", fontSize: "13px" }}>
                  <thead>
                    <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.08)", color: "var(--accent-gold)", textAlign: "left" }}>
                  ...
                  <tbody>
                    <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
                      ...
                      <td style={{ padding: "8px 0", color: "var(--accent-teal)" }}>VARCHAR(36)</td>
                      <td style={{ padding: "8px 0" }}>Unique device UUID</td>
                    </tr>
                    <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
                      <td style={{ padding: "8px 0", fontFamily: "var(--font-mono)", fontSize: "12px" }}>latitude</td>
                      <td style={{ padding: "8px 0", color: "var(--accent-teal)" }}>DECIMAL(9,6)</td>
                    ...
                    <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
                      ...
                      <td style={{ padding: "8px 0", color: "var(--accent-teal)" }}>FLOAT</td>
